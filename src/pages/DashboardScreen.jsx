          ...
          <div className="bg-teal-700 text-white rounded-xl p-6">
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                { label: "Thông tin cá nhân", to: "/profile", icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg> },
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6">
            ...
            <div className="flex flex-col gap-2 text-sm text-slate-600">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-teal-100 text-teal-500 flex items-center justify-center flex-shrink-0">
